...
- 목록 썸네일(`ProductArt`)은 `loading="lazy"`로 화면에 가까운 사진만 요청한다. 다만 88px 칸에 1000px 원본을 받으므로, 저장소를 옮길 때 목록용 썸네일을 함께 만든다.
...
| 와인 사진 (2026-09-26) | 2장, 750×1000 WebP 27.2 KB·30.2 KB (장당 약 29 KB). 64종 모두 등록 시 약 1.8 MB |
