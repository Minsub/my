...
- 합친 증상(`symptomEpisodes`): 배뭉침·통증을 시작 순으로 놓고, 앞 증상이 끝나기 전에 시작한 기록은 같은 증상으로 묶는다. 증상의 지속은 묶인 기록 중 가장 이른 시작 → 가장 늦은 종료, 간격은 증상 시작 → 다음 증상 시작이며 60분을 넘으면 새 구간이다. 타입별 보기의 배뭉침·통증 탭에서만 쓴다.
